...
func TestLocalDocument_AP_Mastodon_JSON(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-ap-mastodon.json", withTestServer())
	require.Nil(t, err)
...
func TestLocalDocument_AP_Mastodon_HTML(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-ap-mastodon.html", withTestServer())
	require.Nil(t, err)
	require.NotNil(t, result.Value())
}
...
func TestLocalDocument_Microformats_1(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-microformats-1.html", withTestServer())
	require.Nil(t, err)
	require.NotNil(t, result.Value())
}
...
func TestLocalDocument_Microformats_2(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-microformats-2.html", withTestServer())
	require.Nil(t, err)
	require.NotNil(t, result.Value())
}
...
func TestLocalDocument_Microformats_3(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-microformats-3.html", withTestServer())
	require.Nil(t, err)
	require.NotNil(t, result.Value())
}
...
func TestLocalActor_Microformats_2(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-microformats-4.html", withTestServer())

	require.Nil(t, err)
	require.NotNil(t, result.Value())
	require.Equal(t, "Page", result.Type())
	require.Equal(t, "https://test-server.local/document-microformats-4.html", result.ID())
	require.Equal(t, "https://test-server.local/IndieWeb", result.AttributedTo().ID())
...
func TestLocalDocument_OpenGraph(t *testing.T) {
	...
	result, err := client.Load("https://test-server.local/document-opengraph-1.html", withTestServer())

	require.Nil(t, err)
	require.NotNil(t, result.Value())
	require.Equal(t, "https://test-server.local/document-opengraph-1.html", result.ID())
	require.Equal(t, "Page", result.Type())
